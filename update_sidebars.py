...
sidebar_template = """    <nav class="sidebar">
        <div class="sidebar-header">
            ...
            <ul class="nav-links">
                ...
                <li><a href="documents.html"%DOCS_ACTIVE%><i class="fas fa-file-alt"></i> <span data-i18n="documents">Documents</span></a></li>
...
def get_sidebar_for_file(active_href):
    ...
    s = s.replace("%DOCS_ACTIVE%", ' class="active"' if active_href == "documents.html" else "")
