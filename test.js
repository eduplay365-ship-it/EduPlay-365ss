const questions = [
    // Mathematics
    {
        text_en: "How many fingers do you have on one hand?",
        text_uz: "Bir qo'lingizda nechta barmoq bor?",
        text_ru: "Сколько пальцев на одной руке?",
        options_en: ["4", "5", "6"],
        options_uz: ["4", "5", "6"],
        options_ru: ["4", "5", "6"],
        correct: 1
...
function loadQuestion() {
    ...
    questionTextEl.textContent = q[`text_${lang}`];
